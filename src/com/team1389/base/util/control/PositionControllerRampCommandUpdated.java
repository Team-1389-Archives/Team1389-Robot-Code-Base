...
/*
// Created from a copy of PositionControllerRampCommand. At the competition, should be able to switch out
 * the old command for this new one, but keeping the old one so that can be easily reverted
 */
public class PositionControllerRampCommandUpdated extends Command{
	...
	public PositionControllerRampCommandUpdated(PositionController controller, SetpointProvider setpointProvider,
	...
	public PositionControllerRampCommandUpdated(TalonSRXPositionHardware controller, SetpointProvider provider, PIDConstants pidC) {
